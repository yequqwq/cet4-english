    ...
    questions: [
      {
        ...
        answer: 1,
        explanation:
          '文章提到互联网的起源可以追溯到20世纪60年代，第一个网络ARPANET是在那个时期开发的。',
      },
      {
        id: 'r3q2',
      ...
      },
      {
        ...
        answer: 2,
        explanation:
          '文章提到域名系统(DNS)使得用户可以使用人类可读的地址而不是数字IP地址来浏览互联网，这使得互联网对更广泛的受众开放。',
      },
      {
        id: 'r3q4',
