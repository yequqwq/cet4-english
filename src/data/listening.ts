...
export const listeningQuestions: ListeningQuestion[] = [
  ...
  },
  {
    ...
    type: 'short',
    audioText:
      'M: I heard you got an A in the English exam. Congratulations!\nW: Thank you. I studied really hard for it.',
  ...
  },
  {
    ...
    type: 'news',
    audioText:
      'Scientists have announced a breakthrough in renewable energy technology. The new solar panel design can convert sunlight into electricity with an efficiency rate of over 40%, which is significantly higher than current models. This development could make solar energy more affordable and accessible for households around the world.',
    question: 'What is the main idea of this news?',
    options: [
      'A new solar panel design with high efficiency',
      'The cost of solar energy has increased',
      'Scientists have discovered a new energy source',
      'Solar energy is now available worldwide',
    ],
    answer: 0,
  ...
  },
  {
    ...
    type: 'news',
    audioText:
      'The government has launched a new initiative to promote reading among young people. The program includes building more community libraries, organizing reading clubs, and providing free books to schools. Officials hope this will encourage a love of reading and improve literacy rates.',
    question: 'What is the purpose of the government initiative?',
    options: [
      'To build more schools',
      'To promote reading among young people',
      'To provide free computers',
  ...
  },
  {
    ...
    options: [
      'Yes, you need professional experience',
      'Yes, you need some basic experience',
      'No, beginners are welcome',
      'No, but you need to pay a fee',
    ],
    answer: 2,
