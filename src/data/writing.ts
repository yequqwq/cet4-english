...
export const translationExamples = [
  {
    ...
    english: 'With the development of the economy, more and more people are beginning to pay attention to environmental protection.',
  },
  {
    id: 't2',
    chinese: '教育是一个国家发展的基石，政府应该加大对教育的投入。',
    english: 'Education is the cornerstone of a country\'s development, and the government should increase investment in education.',
  },
  {
    id: 't3',
    chinese: '科技的进步改变了我们的生活方式，让我们的生活更加便捷。',
    english: 'Advancements in technology have changed our way of life, making our lives more convenient.',
  },
  {
    id: 't4',
    chinese: '文化交流有助于增进不同国家人民之间的理解和友谊。',
    english: 'Cultural exchange helps promote understanding and friendship between people from different countries.',
  },
  {
    id: 't5',
    chinese: '保护环境是每个人的责任，我们应该从身边的小事做起。',
    english: 'Protecting the environment is everyone\'s responsibility, and we should start with small things around us.',
  },
];
